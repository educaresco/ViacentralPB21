$PBExportHeader$w_cancelar_invoice2.srw
forward
global type w_cancelar_invoice2 from wb_response
end type
type pb_message_mt from picturebutton within w_cancelar_invoice2
end type
type st_3 from statictext within w_cancelar_invoice2
end type
type lst_cancelation_reason from my_ddlb within w_cancelar_invoice2
end type
type cb_removecancelationrequest from commandbutton within w_cancelar_invoice2
end type
type st_modecanc from statictext within w_cancelar_invoice2
end type
type st_payer from statictext within w_cancelar_invoice2
end type
type p_2 from picture within w_cancelar_invoice2
end type
type cb_2 from commandbutton within w_cancelar_invoice2
end type
type cbx_force from checkbox within w_cancelar_invoice2
end type
type sle_reason from singlelineedit within w_cancelar_invoice2
end type
type cbx_refund from checkbox within w_cancelar_invoice2
end type
type cb_1 from commandbutton within w_cancelar_invoice2
end type
type st_1 from statictext within w_cancelar_invoice2
end type
type em_invoice from editmask within w_cancelar_invoice2
end type
type st_2 from statictext within w_cancelar_invoice2
end type
type sle_branch from singlelineedit within w_cancelar_invoice2
end type
type dw_1 from datawindow within w_cancelar_invoice2
end type
type gb_1 from groupbox within w_cancelar_invoice2
end type
type p_1 from picture within w_cancelar_invoice2
end type
end forward
...
global w_cancelar_invoice2 w_cancelar_invoice2
...
on w_cancelar_invoice2.destroy
call super::destroy
