$PBExportHeader$w_sales_report_modo_pago.srw
forward
global type w_sales_report_modo_pago from Window
end type
type em_modo_pago from editmask within w_sales_report_modo_pago
end type
type st_24 from statictext within w_sales_report_modo_pago
end type
type cb_7 from commandbutton within w_sales_report_modo_pago
end type
type dw_2 from datawindow within w_sales_report_modo_pago
end type
type dw_1 from datawindow within w_sales_report_modo_pago
end type
type cb_6 from commandbutton within w_sales_report_modo_pago
end type
type cb_5 from commandbutton within w_sales_report_modo_pago
end type
type cb_4 from commandbutton within w_sales_report_modo_pago
end type
type cb_3 from commandbutton within w_sales_report_modo_pago
end type
type cb_2 from commandbutton within w_sales_report_modo_pago
end type
type cb_1 from commandbutton within w_sales_report_modo_pago
end type
type sle_source_country from singlelineedit within w_sales_report_modo_pago
end type
type sle_source_state from singlelineedit within w_sales_report_modo_pago
end type
type sle_target_country from singlelineedit within w_sales_report_modo_pago
end type
type sle_source_group from singlelineedit within w_sales_report_modo_pago
end type
type st_6 from statictext within w_sales_report_modo_pago
end type
type st_5 from statictext within w_sales_report_modo_pago
end type
type st_4 from statictext within w_sales_report_modo_pago
end type
type st_3 from statictext within w_sales_report_modo_pago
end type
type cbx_1 from checkbox within w_sales_report_modo_pago
end type
type em_fecha2 from editmask within w_sales_report_modo_pago
end type
type em_fecha1 from editmask within w_sales_report_modo_pago
end type
type st_2 from statictext within w_sales_report_modo_pago
end type
type st_1 from statictext within w_sales_report_modo_pago
end type
end forward
...
global w_sales_report_modo_pago w_sales_report_modo_pago

on w_sales_report_modo_pago.create
...
on w_sales_report_modo_pago.destroy
...
int Height=960
int TabOrder=170
string DataObject="dw_sales_report_resumen_pais_modo_pago"
BorderStyle BorderStyle=StyleLowered!
...
int Height=1048
int TabOrder=160
string DataObject="dw_sales_report_modo_pago"
BorderStyle BorderStyle=StyleLowered!
boolean HScrollBar=true
boolean VScrollBar=true
boolean HSplitScroll=true
...
dw_1.Retrieve(date(em_fecha1.text),RelativeDate(date(em_fecha2.text),1),em_modo_pago.text)
dw_2.Retrieve(date(em_fecha1.text),RelativeDate(date(em_fecha2.text),1),em_modo_pago.text)
end event
