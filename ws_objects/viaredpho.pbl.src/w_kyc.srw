$PBExportHeader$w_kyc.srw
forward
global type w_kyc from pfc_w_response
end type
type cb_send_sender_folder from commandbutton within w_kyc
end type
type cb_print from commandbutton within w_kyc
end type
type dw_kyc_data from datawindow within w_kyc
end type
type lb_1 from listbox within w_kyc
end type
type ole_kyc from olecustomcontrol within w_kyc
end type
end forward
...
is_kycfilepath = "C:\ViamericasMT\Forms\"+is_kycfile+".tif"
...
fontfamily fontfamily = swiss!
string facename = "Verdana"
string text = "&Enviar a la Agencia"
end type

event clicked;

//ole_kyc.object.PrintImage(true)

//ole_kyc.object.TextColor = RGB(0,200,0)
//ole_kyc.object.TextFontName="ActiveFax"
//ole_kyc.object.DrawText(80,80,""+is_faxparms)

ole_kyc.object.PrintSetDocumentName="KYC " + is_faxparms
ole_kyc.object.PrintSetQuality=0
ole_kyc.object.PrintImage2Printer("ActiveFax")

close(parent)

//ole_kyc.object.save("C:\ViamericasAG\Output\KYC_"+is_id_branch+'-'+String(id_id_receiver)+'-'+String(today(),"mmddyyyy")+string(now(),"hhmmss")+'',"TIF")

end event

event constructor;if fn_getlang() = 'EN' then this.text = "&Print (Use PDF to Save)"
end event
...
event mousedown(integer button, integer shift, long ocx_x, long ocx_y);lb_1.additem(String(ocx_x)+" " + String(ocx_y))
end event


Start of PowerBuilder Binary Data Section : Do NOT Edit
04w_kyc.bin 

