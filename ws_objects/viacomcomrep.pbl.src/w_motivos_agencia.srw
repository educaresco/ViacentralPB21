$PBExportHeader$w_motivos_agencia.srw
forward
global type w_motivos_agencia from wb_report_fechas
end type
type em_1 from editmask within w_motivos_agencia
end type
type st_3 from statictext within w_motivos_agencia
end type
type cb_1 from commandbutton within w_motivos_agencia
end type
end forward
...
global w_motivos_agencia w_motivos_agencia

type variables
string	is_output
end variables

on w_motivos_agencia.create
int iCurrent
call super::create
...
type dw_1 from wb_report_fechas`dw_1 within w_motivos_agencia
int X=23
int Y=160
int Width=3090
int TabOrder=50
boolean BringToTop=true
string DataObject="dw_motivos_agencia"
end type

type em_fecha1 from wb_report_fechas`em_fecha1 within w_motivos_agencia
int X=978
boolean BringToTop=true
end type

type st_1 from wb_report_fechas`st_1 within w_motivos_agencia
int X=613
int Y=44
boolean BringToTop=true
end type

type st_2 from wb_report_fechas`st_2 within w_motivos_agencia
int X=1778
int Y=44
boolean BringToTop=true
end type

type em_fecha2 from wb_report_fechas`em_fecha2 within w_motivos_agencia
int X=2144
boolean BringToTop=true
end type
