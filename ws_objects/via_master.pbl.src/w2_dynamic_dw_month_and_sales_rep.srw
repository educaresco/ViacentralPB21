$PBExportHeader$w2_dynamic_dw_month_and_sales_rep.srw
forward
global type w2_dynamic_dw_month_and_sales_rep from w_sheet
end type
type cb_1 from commandbutton within w2_dynamic_dw_month_and_sales_rep
end type
type lst_manager from my_ddlb within w2_dynamic_dw_month_and_sales_rep
end type
type st_3 from statictext within w2_dynamic_dw_month_and_sales_rep
end type
type lst_month from my_ddlb within w2_dynamic_dw_month_and_sales_rep
end type
type sle_idbranch from singlelineedit within w2_dynamic_dw_month_and_sales_rep
end type
type st_1 from statictext within w2_dynamic_dw_month_and_sales_rep
end type
type em_year from editmask within w2_dynamic_dw_month_and_sales_rep
end type
type st_2 from statictext within w2_dynamic_dw_month_and_sales_rep
end type
type dw_1 from u_dw within w2_dynamic_dw_month_and_sales_rep
end type
type gb_1 from groupbox within w2_dynamic_dw_month_and_sales_rep
end type
end forward
...
global w2_dynamic_dw_month_and_sales_rep w2_dynamic_dw_month_and_sales_rep
...
on w2_dynamic_dw_month_and_sales_rep.create
int iCurrent
call super::create
...
on w2_dynamic_dw_month_and_sales_rep.destroy
call super::destroy
...
event constructor;call super::constructor;this.addquery("SELECT dba.AGENT.NAME_AGENT, dba.AGENT.ID_AGENT FROM dba.AGENT WHERE dba.AGENT.STATUS_AGENT = 'A' ORDER BY 1;")
end event
