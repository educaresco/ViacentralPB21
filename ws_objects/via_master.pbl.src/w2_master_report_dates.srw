$PBExportHeader$w2_master_report_dates.srw
forward
global type w2_master_report_dates from w_sheet
end type
type st_4 from statictext within w2_master_report_dates
end type
type st_3 from statictext within w2_master_report_dates
end type
type cb_query from commandbutton within w2_master_report_dates
end type
type pb_date1 from picturebutton within w2_master_report_dates
end type
type em_date1 from pfc_u_em within w2_master_report_dates
end type
type pb_date2 from picturebutton within w2_master_report_dates
end type
type em_date2 from pfc_u_em within w2_master_report_dates
end type
type dw_1 from u_dw within w2_master_report_dates
end type
type gb_1 from groupbox within w2_master_report_dates
end type
end forward
...
global w2_master_report_dates w2_master_report_dates

on w2_master_report_dates.create
int iCurrent
call super::create
...
on w2_master_report_dates.destroy
call super::destroy
