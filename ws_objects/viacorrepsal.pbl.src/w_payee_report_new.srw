$PBExportHeader$w_payee_report_new.srw
forward
global type w_payee_report_new from Window
end type
type sle_target_state from singlelineedit within w_payee_report_new
end type
type st_5 from statictext within w_payee_report_new
end type
type cb_7 from commandbutton within w_payee_report_new
end type
type cb_4 from commandbutton within w_payee_report_new
end type
type cb_3 from commandbutton within w_payee_report_new
end type
type cb_2 from commandbutton within w_payee_report_new
end type
type cbx_filter1 from checkbox within w_payee_report_new
end type
type dw_2 from datawindow within w_payee_report_new
end type
type dw_1 from datawindow within w_payee_report_new
end type
type cb_1 from commandbutton within w_payee_report_new
end type
type sle_target_contry from singlelineedit within w_payee_report_new
end type
type sle_target_group from singlelineedit within w_payee_report_new
end type
type st_4 from statictext within w_payee_report_new
end type
type st_3 from statictext within w_payee_report_new
end type
type em_fecha2 from editmask within w_payee_report_new
end type
type em_fecha1 from editmask within w_payee_report_new
end type
type st_2 from statictext within w_payee_report_new
end type
type st_1 from statictext within w_payee_report_new
end type
end forward
...
global w_payee_report_new w_payee_report_new

on w_payee_report_new.create
...
int Height=1020
int TabOrder=40
string DataObject="dw_payee_report_resumen_state"
BorderStyle BorderStyle=StyleLowered!
