$PBExportHeader$w_groupvscountry_foreing.srw
forward
global type w_groupvscountry_foreing from Window
end type
type cb_3 from commandbutton within w_groupvscountry_foreing
end type
type cb_2 from commandbutton within w_groupvscountry_foreing
end type
type cb_1 from commandbutton within w_groupvscountry_foreing
end type
type dw_1 from datawindow within w_groupvscountry_foreing
end type
type em_fecha2 from editmask within w_groupvscountry_foreing
end type
type em_fecha1 from editmask within w_groupvscountry_foreing
end type
type st_2 from statictext within w_groupvscountry_foreing
end type
type st_1 from statictext within w_groupvscountry_foreing
end type
end forward
...
global w_groupvscountry_foreing w_groupvscountry_foreing

on w_groupvscountry_foreing.create
...
on w_groupvscountry_foreing.destroy
destroy(this.cb_3)
destroy(this.cb_2)
destroy(this.cb_1)
destroy(this.dw_1)
...
event clicked;close(w_groupvscountry_foreing)
end event
...
MESSAGEBOX("File Name Is c:\GCFX.txt","OK")

ls_file = 'c:\GCFX.txt'
li_FileNum = FileOpen(ls_file,LineMode!, Write!, LockWrite!, Replace!)
ls_cadena = 'FOREING EXCHANGE GROUP VS COUNTRY'
...
DO WHILE SQLCA.SQLCODE = 0
	...
	SELECT sum(dba.receiver.total_diference)
   INTO :ll_positivo
...
int Height=1872
int TabOrder=50
string DataObject="dw_grupovscountry_fx"
