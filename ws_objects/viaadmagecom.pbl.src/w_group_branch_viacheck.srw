$PBExportHeader$w_group_branch_viacheck.srw
forward
global type w_group_branch_viacheck from wb_single_tb
end type
type sle_branch from singlelineedit within w_group_branch_viacheck
end type
type lst_branch from my_ddlb within w_group_branch_viacheck
end type
type st_1 from statictext within w_group_branch_viacheck
end type
type gb_1 from groupbox within w_group_branch_viacheck
end type
end forward
...
global w_group_branch_viacheck w_group_branch_viacheck
...
on w_group_branch_viacheck.create
int iCurrent
call super::create
...
on w_group_branch_viacheck.destroy
call super::destroy
...
type dw_1 from wb_single_tb`dw_1 within w_group_branch_viacheck
integer y = 176
integer width = 4315
integer height = 1704
string dataobject = "dw_group_branch_viacheck"
end type
