$PBExportHeader$w_despliegue_balance_commissions.srw
forward
global type w_despliegue_balance_commissions from window
end type
type cb_5 from commandbutton within w_despliegue_balance_commissions
end type
type cb_4 from commandbutton within w_despliegue_balance_commissions
end type
type sle_fixgroup from singlelineedit within w_despliegue_balance_commissions
end type
type cb_3 from commandbutton within w_despliegue_balance_commissions
end type
type cb_query from commandbutton within w_despliegue_balance_commissions
end type
type st_2 from statictext within w_despliegue_balance_commissions
end type
type cb_date from commandbutton within w_despliegue_balance_commissions
end type
type em_date from u_em within w_despliegue_balance_commissions
end type
type cb_id from commandbutton within w_despliegue_balance_commissions
end type
type cb_name from commandbutton within w_despliegue_balance_commissions
end type
type cb_credit from commandbutton within w_despliegue_balance_commissions
end type
type cb_debit from commandbutton within w_despliegue_balance_commissions
end type
type cb_balance from commandbutton within w_despliegue_balance_commissions
end type
type cb_2 from commandbutton within w_despliegue_balance_commissions
end type
type rb_both from radiobutton within w_despliegue_balance_commissions
end type
type rb_payees from radiobutton within w_despliegue_balance_commissions
end type
type rb_agencies from radiobutton within w_despliegue_balance_commissions
end type
type st_1 from statictext within w_despliegue_balance_commissions
end type
type dw_1 from u_dw within w_despliegue_balance_commissions
end type
type sle_search from singlelineedit within w_despliegue_balance_commissions
end type
type cb_recalcular_datedeposit from commandbutton within w_despliegue_balance_commissions
end type
type cb_recalcular_state from commandbutton within w_despliegue_balance_commissions
end type
type cb_recalcular_balance_poner_en_group from commandbutton within w_despliegue_balance_commissions
end type
type cb_print_filter from commandbutton within w_despliegue_balance_commissions
end type
type cb_select from commandbutton within w_despliegue_balance_commissions
end type
type cb_1 from commandbutton within w_despliegue_balance_commissions
end type
type gb_1 from groupbox within w_despliegue_balance_commissions
end type
type gb_3 from groupbox within w_despliegue_balance_commissions
end type
type r_1 from rectangle within w_despliegue_balance_commissions
end type
end forward
...
global w_despliegue_balance_commissions w_despliegue_balance_commissions
...
String ls_type, ls_namebranch, ls_idmainbranch, ls_state, ls_date
Long ll_row
...
OPEN cur_groups;
FETCH cur_groups INTO :ls_idmainbranch, :ls_namebranch, :ls_state;
...
ld_fecha  = Datetime(relativedate(today(),1),time('00:00:00'))

IF dw_1.retrieve("B",ld_fecha) > 0 THEN
	dw_1.Scrolltorow(1)
	dw_1.SetRow(1)
...
on w_despliegue_balance_commissions.create
...
on w_despliegue_balance_commissions.destroy
destroy(this.cb_5)
destroy(this.cb_4)
...
datetime ld_date,ld_fecha 
ld_date = datetime(date(em_date.text),time('23:59:59'))

ld_fecha  = Datetime(today(),time('00:00:00'))
...
if date(em_date.text) >= today() then
	...
	dw_1.DataObject = 'dw_despliegue_balance_rapido_comm'
	
	dw_1.SetTransObject(SQLCArpt)
	IF dw_1.retrieve(ls_type,ld_fecha) > 0 THEN
		dw_1.Scrolltorow(1)
		dw_1.SetRow(1)
		dw_1.SelectRow(0, FALSE)
		dw_1.SelectRow(1, TRUE)
	...
	ld_date = datetime(relativedate(date(em_date.text),1),time('00:00:00'))
	dw_1.retrieve(ls_type,ld_date) 
...
integer height = 1232
integer taborder = 40
string dataobject = "dw_despliegue_balance_rapido_comm"
