$PBExportHeader$w_rep_transmision_fax_fecha_hor_corr_not.srw
forward
global type w_rep_transmision_fax_fecha_hor_corr_not from wb_report_fechas
end type
type em_hora from u_em within w_rep_transmision_fax_fecha_hor_corr_not
end type
type st_3 from statictext within w_rep_transmision_fax_fecha_hor_corr_not
end type
type sle_grupo from singlelineedit within w_rep_transmision_fax_fecha_hor_corr_not
end type
type st_4 from statictext within w_rep_transmision_fax_fecha_hor_corr_not
end type
type cb_1 from commandbutton within w_rep_transmision_fax_fecha_hor_corr_not
end type
end forward
...
global w_rep_transmision_fax_fecha_hor_corr_not w_rep_transmision_fax_fecha_hor_corr_not

on w_rep_transmision_fax_fecha_hor_corr_not.create
int iCurrent
call super::create
...
on w_rep_transmision_fax_fecha_hor_corr_not.destroy
call super::destroy
...
type dw_1 from wb_report_fechas`dw_1 within w_rep_transmision_fax_fecha_hor_corr_not
int X=9
int Y=164
int Height=1572
int TabOrder=50
boolean BringToTop=true
string DataObject="dw_rep_envio_transmitir_fec_hor_corr_not"
end type

type em_fecha1 from wb_report_fechas`em_fecha1 within w_rep_transmision_fax_fecha_hor_corr_not
int X=434
boolean BringToTop=true
end type

type st_1 from wb_report_fechas`st_1 within w_rep_transmision_fax_fecha_hor_corr_not
int X=69
boolean BringToTop=true
end type

type st_2 from wb_report_fechas`st_2 within w_rep_transmision_fax_fecha_hor_corr_not
int X=832
boolean BringToTop=true
end type

type em_fecha2 from wb_report_fechas`em_fecha2 within w_rep_transmision_fax_fecha_hor_corr_not
int X=1202
boolean BringToTop=true
end type
