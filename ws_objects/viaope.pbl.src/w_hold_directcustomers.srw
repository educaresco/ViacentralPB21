$PBExportHeader$w_hold_directcustomers.srw
forward
global type w_hold_directcustomers from window
end type
type cb_refresh from commandbutton within w_hold_directcustomers
end type
type cb_file from commandbutton within w_hold_directcustomers
end type
type cb_4 from commandbutton within w_hold_directcustomers
end type
type cb_2 from commandbutton within w_hold_directcustomers
end type
type cb_liberar from commandbutton within w_hold_directcustomers
end type
type dw_3 from datawindow within w_hold_directcustomers
end type
type rb_suspicious from radiobutton within w_hold_directcustomers
end type
type rb_history from radiobutton within w_hold_directcustomers
end type
type cb_cancelados from commandbutton within w_hold_directcustomers
end type
type cb_anulados from commandbutton within w_hold_directcustomers
end type
type dw_2 from datawindow within w_hold_directcustomers
end type
type dw_1 from datawindow within w_hold_directcustomers
end type
type gb_1 from groupbox within w_hold_directcustomers
end type
end forward
...
string title = "Direct Customer Holds (Credit Risk)"
...
global w_hold_directcustomers w_hold_directcustomers

forward prototypes
public subroutine fn_refresh_screen ()
end prototypes

public subroutine fn_refresh_screen ();dw_2.dataobject = 'dw_hold_directcustomers'
...
on w_hold_directcustomers.create
...
on w_hold_directcustomers.destroy
...
integer height = 1288
integer taborder = 10
string dataobject = "dw_hold_directcustomers"
...
event buttonclicked;Double ld_sender_global
...
string dataobject = "dw_hold_directcustomers_motivos"
boolean vscrollbar = true
boolean livescroll = true
end type
