$PBExportHeader$w_despliegue_transacciones_nat_cpc.srw
forward
global type w_despliegue_transacciones_nat_cpc from window
end type
type cb_4 from commandbutton within w_despliegue_transacciones_nat_cpc
end type
type cb_fax from commandbutton within w_despliegue_transacciones_nat_cpc
end type
type lb_fax from listbox within w_despliegue_transacciones_nat_cpc
end type
type cb_3 from commandbutton within w_despliegue_transacciones_nat_cpc
end type
type sle_des2 from singlelineedit within w_despliegue_transacciones_nat_cpc
end type
type sle_des1 from singlelineedit within w_despliegue_transacciones_nat_cpc
end type
type em_1 from editmask within w_despliegue_transacciones_nat_cpc
end type
type rb_1 from radiobutton within w_despliegue_transacciones_nat_cpc
end type
type cb_conciliar from commandbutton within w_despliegue_transacciones_nat_cpc
end type
type cb_2 from commandbutton within w_despliegue_transacciones_nat_cpc
end type
type rb_acoount from radiobutton within w_despliegue_transacciones_nat_cpc
end type
type rb_date from radiobutton within w_despliegue_transacciones_nat_cpc
end type
type dw_2 from datawindow within w_despliegue_transacciones_nat_cpc
end type
type cb_print from commandbutton within w_despliegue_transacciones_nat_cpc
end type
type cb_select from commandbutton within w_despliegue_transacciones_nat_cpc
end type
type cb_1 from commandbutton within w_despliegue_transacciones_nat_cpc
end type
type dw_1 from u_dw within w_despliegue_transacciones_nat_cpc
end type
type gb_1 from groupbox within w_despliegue_transacciones_nat_cpc
end type
end forward
...
global w_despliegue_transacciones_nat_cpc w_despliegue_transacciones_nat_cpc
...
on w_despliegue_transacciones_nat_cpc.create
...
on w_despliegue_transacciones_nat_cpc.destroy
destroy(this.cb_4)
destroy(this.cb_fax)
destroy(this.lb_fax)
destroy(this.cb_3)
...
integer height = 1692
integer taborder = 0
string dataobject = "dw_despliegue_transacciones_nat_cpc"
