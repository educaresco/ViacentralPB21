$PBExportHeader$w_despliegue_balance_nat.srw
forward
global type w_despliegue_balance_nat from window
end type
type cb_5 from commandbutton within w_despliegue_balance_nat
end type
type cb_4 from commandbutton within w_despliegue_balance_nat
end type
type sle_fixgroup from singlelineedit within w_despliegue_balance_nat
end type
type cb_3 from commandbutton within w_despliegue_balance_nat
end type
type cb_query from commandbutton within w_despliegue_balance_nat
end type
type st_2 from statictext within w_despliegue_balance_nat
end type
type cb_date from commandbutton within w_despliegue_balance_nat
end type
type em_date from u_em within w_despliegue_balance_nat
end type
type cb_id from commandbutton within w_despliegue_balance_nat
end type
type cb_name from commandbutton within w_despliegue_balance_nat
end type
type cb_credit from commandbutton within w_despliegue_balance_nat
end type
type cb_debit from commandbutton within w_despliegue_balance_nat
end type
type cb_balance from commandbutton within w_despliegue_balance_nat
end type
type cb_2 from commandbutton within w_despliegue_balance_nat
end type
type rb_both from radiobutton within w_despliegue_balance_nat
end type
type rb_payees from radiobutton within w_despliegue_balance_nat
end type
type rb_agencies from radiobutton within w_despliegue_balance_nat
end type
type st_1 from statictext within w_despliegue_balance_nat
end type
type dw_1 from u_dw within w_despliegue_balance_nat
end type
type sle_search from singlelineedit within w_despliegue_balance_nat
end type
type cb_recalcular_datedeposit from commandbutton within w_despliegue_balance_nat
end type
type cb_recalcular_state from commandbutton within w_despliegue_balance_nat
end type
type cb_recalcular_balance_poner_en_group from commandbutton within w_despliegue_balance_nat
end type
type cb_select_cpc from commandbutton within w_despliegue_balance_nat
end type
type cb_print_filter from commandbutton within w_despliegue_balance_nat
end type
type cb_select from commandbutton within w_despliegue_balance_nat
end type
type cb_1 from commandbutton within w_despliegue_balance_nat
end type
type gb_1 from groupbox within w_despliegue_balance_nat
end type
type gb_3 from groupbox within w_despliegue_balance_nat
end type
type r_1 from rectangle within w_despliegue_balance_nat
end type
end forward
...
global w_despliegue_balance_nat w_despliegue_balance_nat
...
on w_despliegue_balance_nat.create
...
on w_despliegue_balance_nat.destroy
destroy(this.cb_5)
destroy(this.cb_4)
...
if date(em_date.text) >= today() then
	...
	dw_1.DataObject = 'dw_despliegue_balance_rapido_nat'
	dw_1.SetTransObject(SQLCA)
	...
	dw_1.DataObject = 'dw_despliegue_balance_previo_runtm_nat'
	dw_1.SetTransObject(SQLCA)	
...
integer height = 1232
integer taborder = 40
string dataobject = "dw_despliegue_balance_rapido_nat"
...
if ll_row <> 0 then
	...
	Openwithparm(w_despliegue_transacciones_nat_cpc,ls_group)
end if
end event
...
if ll_row <> 0 then
	ls_group = dw_1.getitemstring(ll_row,"id_group_trans_diaria")
	Openwithparm(w_despliegue_transacciones_nat,ls_group)
end if
end event
