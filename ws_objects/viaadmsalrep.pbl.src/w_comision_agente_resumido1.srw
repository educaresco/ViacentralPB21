$PBExportHeader$w_comision_agente_resumido1.srw
forward
global type w_comision_agente_resumido1 from w_sheet
end type
type dw_1 from u_dw within w_comision_agente_resumido1
end type
type em_fecha1 from u_em within w_comision_agente_resumido1
end type
type st_1 from statictext within w_comision_agente_resumido1
end type
type st_2 from statictext within w_comision_agente_resumido1
end type
type em_fecha2 from u_em within w_comision_agente_resumido1
end type
end forward
...
global w_comision_agente_resumido1 w_comision_agente_resumido1

on w_comision_agente_resumido1.create
int iCurrent
call super::create
...
on w_comision_agente_resumido1.destroy
call super::destroy
...
string DataObject="dw_calculo_comision_agentes_res1"
