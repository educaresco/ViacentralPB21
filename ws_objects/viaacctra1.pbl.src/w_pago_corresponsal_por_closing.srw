$PBExportHeader$w_pago_corresponsal_por_closing.srw
forward
global type w_pago_corresponsal_por_closing from wb_response
end type
type dw_1 from datawindow within w_pago_corresponsal_por_closing
end type
type dw_2 from datawindow within w_pago_corresponsal_por_closing
end type
type cb_1 from commandbutton within w_pago_corresponsal_por_closing
end type
type em_date from editmask within w_pago_corresponsal_por_closing
end type
type st_1 from statictext within w_pago_corresponsal_por_closing
end type
type cb_2 from commandbutton within w_pago_corresponsal_por_closing
end type
type cb_3 from commandbutton within w_pago_corresponsal_por_closing
end type
type dw_3 from datawindow within w_pago_corresponsal_por_closing
end type
type em_from from editmask within w_pago_corresponsal_por_closing
end type
type em_to from editmask within w_pago_corresponsal_por_closing
end type
type st_2 from statictext within w_pago_corresponsal_por_closing
end type
type st_3 from statictext within w_pago_corresponsal_por_closing
end type
type dw_choise from datawindow within w_pago_corresponsal_por_closing
end type
type cb_4 from commandbutton within w_pago_corresponsal_por_closing
end type
type em_group from editmask within w_pago_corresponsal_por_closing
end type
type st_4 from statictext within w_pago_corresponsal_por_closing
end type
type cb_5 from commandbutton within w_pago_corresponsal_por_closing
end type
type st_6 from statictext within w_pago_corresponsal_por_closing
end type
type cb_salvar from commandbutton within w_pago_corresponsal_por_closing
end type
type cb_continue from commandbutton within w_pago_corresponsal_por_closing
end type
type dw_5 from datawindow within w_pago_corresponsal_por_closing
end type
type em_ajuste from editmask within w_pago_corresponsal_por_closing
end type
type cb_8 from commandbutton within w_pago_corresponsal_por_closing
end type
end forward
...
global w_pago_corresponsal_por_closing w_pago_corresponsal_por_closing
...
on w_pago_corresponsal_por_closing.create
int iCurrent
call super::create
...
this.Control[iCurrent+19]=this.cb_salvar
this.Control[iCurrent+20]=this.cb_continue
this.Control[iCurrent+21]=this.dw_5
this.Control[iCurrent+22]=this.em_ajuste
this.Control[iCurrent+23]=this.cb_8
end on

on w_pago_corresponsal_por_closing.destroy
call super::destroy
destroy(this.dw_1)
destroy(this.dw_2)
destroy(this.cb_1)
...
int TabOrder=140
boolean BringToTop=true
string DataObject="dw_pago_por_cpc"
BorderStyle BorderStyle=StyleLowered!
boolean VScrollBar=true
boolean LiveScroll=true
end type
...
ld_fecha1 = Date(em_from.text)
ld_fecha2 = Date(em_to.text)
...
if ll_cont = 0 then
	messagebox("Warning","A Este corresponsal no se le paga por Confirmacion")
	Return
end if
...
il_row = dw_choise.retrieve(is_group,ld_fecha1,ld_fecha2)
end event
