$PBExportHeader$w_pago_corresponsal_por_closing_rangos.srw
forward
global type w_pago_corresponsal_por_closing_rangos from wb_response
end type
type dw_1 from datawindow within w_pago_corresponsal_por_closing_rangos
end type
type dw_2 from datawindow within w_pago_corresponsal_por_closing_rangos
end type
type cb_1 from commandbutton within w_pago_corresponsal_por_closing_rangos
end type
type em_date from editmask within w_pago_corresponsal_por_closing_rangos
end type
type st_1 from statictext within w_pago_corresponsal_por_closing_rangos
end type
type cb_2 from commandbutton within w_pago_corresponsal_por_closing_rangos
end type
type cb_3 from commandbutton within w_pago_corresponsal_por_closing_rangos
end type
type dw_3 from datawindow within w_pago_corresponsal_por_closing_rangos
end type
type st_2 from statictext within w_pago_corresponsal_por_closing_rangos
end type
type dw_choise from datawindow within w_pago_corresponsal_por_closing_rangos
end type
type cb_4 from commandbutton within w_pago_corresponsal_por_closing_rangos
end type
type em_group from editmask within w_pago_corresponsal_por_closing_rangos
end type
type st_4 from statictext within w_pago_corresponsal_por_closing_rangos
end type
type cb_5 from commandbutton within w_pago_corresponsal_por_closing_rangos
end type
type st_6 from statictext within w_pago_corresponsal_por_closing_rangos
end type
type cb_salvar from commandbutton within w_pago_corresponsal_por_closing_rangos
end type
type cb_continue from commandbutton within w_pago_corresponsal_por_closing_rangos
end type
type dw_5 from datawindow within w_pago_corresponsal_por_closing_rangos
end type
type em_ajuste from editmask within w_pago_corresponsal_por_closing_rangos
end type
type sle_closing1 from singlelineedit within w_pago_corresponsal_por_closing_rangos
end type
type sle_closing2 from singlelineedit within w_pago_corresponsal_por_closing_rangos
end type
type sle_closing3 from singlelineedit within w_pago_corresponsal_por_closing_rangos
end type
type sle_closing4 from singlelineedit within w_pago_corresponsal_por_closing_rangos
end type
type sle_closing5 from singlelineedit within w_pago_corresponsal_por_closing_rangos
end type
type sle_closing6 from singlelineedit within w_pago_corresponsal_por_closing_rangos
end type
type sle_closing7 from singlelineedit within w_pago_corresponsal_por_closing_rangos
end type
type sle_closing8 from singlelineedit within w_pago_corresponsal_por_closing_rangos
end type
type cb_8 from commandbutton within w_pago_corresponsal_por_closing_rangos
end type
end forward
...
string Title="Pay to Payee by Closing"
...
dw_5 dw_5
em_ajuste em_ajuste
sle_closing1 sle_closing1
sle_closing2 sle_closing2
sle_closing3 sle_closing3
sle_closing4 sle_closing4
sle_closing5 sle_closing5
sle_closing6 sle_closing6
sle_closing7 sle_closing7
sle_closing8 sle_closing8
cb_8 cb_8
end type
global w_pago_corresponsal_por_closing_rangos w_pago_corresponsal_por_closing_rangos
...
on w_pago_corresponsal_por_closing_rangos.create
int iCurrent
call super::create
...
this.sle_closing1=create sle_closing1
this.sle_closing2=create sle_closing2
this.sle_closing3=create sle_closing3
this.sle_closing4=create sle_closing4
this.sle_closing5=create sle_closing5
this.sle_closing6=create sle_closing6
this.sle_closing7=create sle_closing7
this.sle_closing8=create sle_closing8
...
this.Control[iCurrent+10]=this.dw_choise
...
this.Control[iCurrent+16]=this.cb_salvar
this.Control[iCurrent+17]=this.cb_continue
this.Control[iCurrent+18]=this.dw_5
this.Control[iCurrent+19]=this.em_ajuste
this.Control[iCurrent+20]=this.sle_closing1
this.Control[iCurrent+21]=this.sle_closing2
this.Control[iCurrent+22]=this.sle_closing3
this.Control[iCurrent+23]=this.sle_closing4
this.Control[iCurrent+24]=this.sle_closing5
this.Control[iCurrent+25]=this.sle_closing6
this.Control[iCurrent+26]=this.sle_closing7
this.Control[iCurrent+27]=this.sle_closing8
this.Control[iCurrent+28]=this.cb_8
end on

on w_pago_corresponsal_por_closing_rangos.destroy
call super::destroy
destroy(this.dw_1)
destroy(this.dw_2)
destroy(this.cb_1)
...
destroy(this.sle_closing1)
destroy(this.sle_closing2)
destroy(this.sle_closing3)
destroy(this.sle_closing4)
destroy(this.sle_closing5)
destroy(this.sle_closing6)
destroy(this.sle_closing7)
destroy(this.sle_closing8)
destroy(this.cb_8)
end on
...
sle_closing2.text = string(0)
sle_closing3.text = string(0)
sle_closing4.text = string(0)
sle_closing5.text = string(0)
sle_closing6.text = string(0)
sle_closing7.text = string(0)
sle_closing8.text = string(0)
...
int TabOrder=200
boolean BringToTop=true
string DataObject="dw_pago_corresponsal_por_closing_rangos"
BorderStyle BorderStyle=StyleLowered!
boolean VScrollBar=true
boolean LiveScroll=true
end type
...
if ll_cont = 0 then
	messagebox("Warning","A Este corresponsal no se le paga por Closing")
	Return
end if
 ...
 SELECT Count(*)  
    ...
    FROM dba.type_pay_group  
   WHERE ( dba.type_pay_group.id_group = :is_group ) AND  
         ( dba.type_pay_group.id_type_pay = 'B' )   ;


if ll_cont > 0 then
	messagebox("Warning","Debe Pagarle a este corresponsal por la opcion -- Pay to Payee by Balance")
	Return
end if

il_row = dw_choise.retrieve(is_group,double(sle_closing1.text),double(sle_closing2.text),double(sle_closing3.text),double(sle_closing4.text),double(sle_closing5.text),double(sle_closing6.text),double(sle_closing7.text),double(sle_closing8.text))
end event
...
ld_date_wire      =   dw_2.getitemdatetime(dw_2.getrow(),"date")
