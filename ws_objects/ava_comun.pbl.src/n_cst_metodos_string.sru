$PBExportHeader$n_cst_metodos_string.sru
$PBExportComments$PFC String service
forward
global type n_cst_metodos_string from n_base
end type
end forward

global type n_cst_metodos_string from n_base autoinstantiate
end type
...
on n_cst_metodos_string.create
call super::create
end on

on n_cst_metodos_string.destroy
call super::destroy
end on
