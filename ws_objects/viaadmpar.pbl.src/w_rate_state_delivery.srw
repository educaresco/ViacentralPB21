$PBExportHeader$w_rate_state_delivery.srw
forward
global type w_rate_state_delivery from wb_single_tb
end type
end forward
...
global w_rate_state_delivery w_rate_state_delivery

on w_rate_state_delivery.create
call super::create
end on

on w_rate_state_delivery.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_1 from wb_single_tb`dw_1 within w_rate_state_delivery
int Width=3438
int Height=1372
boolean BringToTop=true
string DataObject="dw_rate_state_delivery"
end type
