$PBExportHeader$w_rep_detail_summary.srw
forward
global type w_rep_detail_summary from wb_report_fechas
end type
type cb_consult from commandbutton within w_rep_detail_summary
end type
type ddlb_maingroup from dropdownlistbox within w_rep_detail_summary
end type
type cbx_1 from checkbox within w_rep_detail_summary
end type
type gb_1 from groupbox within w_rep_detail_summary
end type
type rb_from from radiobutton within w_rep_detail_summary
end type
type rb_to from radiobutton within w_rep_detail_summary
end type
type cbx_branch from checkbox within w_rep_detail_summary
end type
type ddlb_branch from dropdownlistbox within w_rep_detail_summary
end type
type rb_fromd from radiobutton within w_rep_detail_summary
end type
type ddlb_company from dropdownlistbox within w_rep_detail_summary
end type
type cbx_company from checkbox within w_rep_detail_summary
end type
end forward
...
global w_rep_detail_summary w_rep_detail_summary
...
on w_rep_detail_summary.create
int iCurrent
call super::create
...
on w_rep_detail_summary.destroy
call super::destroy
...
dw_1.dataobject='dw_rep_detail_cost_from_group_summary'
...
type dw_1 from wb_report_fechas`dw_1 within w_rep_detail_summary
int X=23
int Y=192
int Width=3511
int Height=1876
...
string DataObject="dw_rep_detail_cost_from_group_summary"
end type
...
type em_fecha1 from wb_report_fechas`em_fecha1 within w_rep_detail_summary
int X=2130
int Y=36
int Width=361
int Height=88
...
type st_1 from wb_report_fechas`st_1 within w_rep_detail_summary
int X=1943
int Y=48
int Width=183
int Height=48
...
type st_2 from wb_report_fechas`st_2 within w_rep_detail_summary
int X=2606
int Y=52
int Width=160
int Height=52
...
type em_fecha2 from wb_report_fechas`em_fecha2 within w_rep_detail_summary
int X=2775
int Y=36
int Width=357
int Height=88
...
event clicked;dw_1.dataobject='dw_rep_detail_cost_from_group_summary'
dw_1.SetTransObject(SQLCA)
end event
...
event clicked;dw_1.dataobject='dw_rep_detail_cost_to_group_SUMMARY'
dw_1.SetTransObject(SQLCA)
end event
