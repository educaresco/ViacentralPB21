$PBExportHeader$w_rep_acc_aging90.srw
forward
global type w_rep_acc_aging90 from wb_report_fechas
end type
type cb_query from commandbutton within w_rep_acc_aging90
end type
end forward
...
global w_rep_acc_aging90 w_rep_acc_aging90

on w_rep_acc_aging90.create
int iCurrent
call super::create
...
on w_rep_acc_aging90.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
destroy(this.cb_query)
end on

type dw_1 from wb_report_fechas`dw_1 within w_rep_acc_aging90
integer taborder = 0
string dataobject = "dw_rep_aging_export90"
end type

type em_fecha1 from wb_report_fechas`em_fecha1 within w_rep_acc_aging90
...
type st_1 from wb_report_fechas`st_1 within w_rep_acc_aging90
boolean visible = false
integer x = 69
integer y = 52
integer width = 155
...
type st_2 from wb_report_fechas`st_2 within w_rep_acc_aging90
integer x = 142
integer y = 44
integer width = 352
...
type em_fecha2 from wb_report_fechas`em_fecha2 within w_rep_acc_aging90
integer x = 517
integer y = 40
integer width = 398
integer height = 72
