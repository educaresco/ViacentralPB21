$PBExportHeader$w_sales_report_new_ventas_100.srw
forward
global type w_sales_report_new_ventas_100 from Window
end type
type sle_1 from singlelineedit within w_sales_report_new_ventas_100
end type
type cb_7 from commandbutton within w_sales_report_new_ventas_100
end type
type dw_2 from datawindow within w_sales_report_new_ventas_100
end type
type dw_1 from datawindow within w_sales_report_new_ventas_100
end type
type cb_6 from commandbutton within w_sales_report_new_ventas_100
end type
type cb_5 from commandbutton within w_sales_report_new_ventas_100
end type
type cb_4 from commandbutton within w_sales_report_new_ventas_100
end type
type cb_3 from commandbutton within w_sales_report_new_ventas_100
end type
type cb_2 from commandbutton within w_sales_report_new_ventas_100
end type
type cb_1 from commandbutton within w_sales_report_new_ventas_100
end type
type sle_source_country from singlelineedit within w_sales_report_new_ventas_100
end type
type sle_source_state from singlelineedit within w_sales_report_new_ventas_100
end type
type sle_target_country from singlelineedit within w_sales_report_new_ventas_100
end type
type sle_source_group from singlelineedit within w_sales_report_new_ventas_100
end type
type st_6 from statictext within w_sales_report_new_ventas_100
end type
type st_5 from statictext within w_sales_report_new_ventas_100
end type
type st_4 from statictext within w_sales_report_new_ventas_100
end type
type st_3 from statictext within w_sales_report_new_ventas_100
end type
type cbx_1 from checkbox within w_sales_report_new_ventas_100
end type
type em_fecha2 from editmask within w_sales_report_new_ventas_100
end type
type em_fecha1 from editmask within w_sales_report_new_ventas_100
end type
type st_2 from statictext within w_sales_report_new_ventas_100
end type
type st_1 from statictext within w_sales_report_new_ventas_100
end type
end forward
...
global w_sales_report_new_ventas_100 w_sales_report_new_ventas_100

on w_sales_report_new_ventas_100.create
...
on w_sales_report_new_ventas_100.destroy
destroy(this.sle_1)
destroy(this.cb_7)
destroy(this.dw_2)
destroy(this.dw_1)
...
dw_1.Retrieve(date(em_fecha1.text),date(em_fecha2.text),sle_1.text)
dw_2.Retrieve(date(em_fecha1.text),date(em_fecha2.text),sle_1.text)
...
int Height=960
int TabOrder=160
string DataObject="dw_sales_report_resumen_pais_ventas100"
BorderStyle BorderStyle=StyleLowered!
...
int Height=1116
int TabOrder=150
string DataObject="dw_sales_report_ventas100"
BorderStyle BorderStyle=StyleLowered!
boolean HScrollBar=true
boolean VScrollBar=true
boolean HSplitScroll=true
...
dw_2.Retrieve(date(em_fecha1.text),date(em_fecha2.text))
end event
