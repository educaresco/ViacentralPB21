...
public function string of_removenonalphaleavespaces (string as_source)
public function string of_removenonalpha (string as_source)
end prototypes
...
public function string of_removenonalphaleavespaces (string as_source);//////////////////////////////////////////////////////////////////////////////
//
//	Function:  		of_RemoveNonAlphaLeaveSpaces
//
//	Access:  		public

//
//	Arguments:
//	as_source		The string from which all nonalpha characters are to
//						be removed - keeps spaces.
//
//	Returns:  		string
//						as_source with all desired characters removed.
//						If any argument's value is NULL, function returns NULL.
//
//	Description: 	Removes all nonalpha characters - keeps spaces.
//
//////////////////////////////////////////////////////////////////////////////
//
//	Revision History
...
FOR ll_loop = 1 TO ll_source_len
	lch_char = Mid(ls_source, ll_pos, 1)
	if of_IsAlpha(lch_char) then
		ll_pos ++	
	else
		if lch_char <> ' ' then ls_source = Replace(ls_source, ll_pos, 1, "")
	end if 
NEXT
...
//						If any argument's value is NULL, function returns NULL.
//
//	Description: 	Removes all nonalpha characters.
//
//////////////////////////////////////////////////////////////////////////////
//
//	Revision History
